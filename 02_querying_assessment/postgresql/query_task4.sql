...
--
-- Your thinking:
-- 1. SELECT ingredients.name to choose 'name' column in 'ingredients' table
-- 2. use FROM to find ingredients table and JOIN suppliers table ON ingredients.supplier_id = suppliers.supplier_id
-- 3. use WHERE to condition suppliers.name = 'Freshest Farm Produce'
select ingredients.name
from ingredients join suppliers
